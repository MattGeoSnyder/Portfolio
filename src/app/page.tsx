...
export default function Home() {
  return (
    <>
      <div
        id="home-page"
        className="w-full h-full md:p-28 grid md:grid-cols-3 md:grid-rows-2 md:gap-16 grid-cols-1 grid-flow-row auto-rows-fr px-12"
      >
        <Resume className="md:row-span-2" key={"Resume"}/>
