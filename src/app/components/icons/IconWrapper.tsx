...
export function IconWrapper({
  ...
  return (
    ...
    >
      <div className="flex md:flex-col md:justify-center md:pt-4 md:pb-1 h-full max-w-full md:gap-x-0 gap-x-8">
        <div className="md:h-3/4 h-full aspect-square">{children}</div>
